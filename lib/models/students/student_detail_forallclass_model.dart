class StudentDetailForAllClassModel {
  String? roll_no;
  ...
  StudentDetailForAllClassModel(
      {this.roll_no,
        ...
        this.class_name,this.section_name,
  ...
  StudentDetailForAllClassModel.fromJson(Map<String, dynamic> json) {
