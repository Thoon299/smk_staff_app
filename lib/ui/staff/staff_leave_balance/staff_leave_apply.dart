...
class StfLevApplyPage extends StatefulWidget {



  @override
  _StfLevApplyPageState createState() => _StfLevApplyPageState();
}

class _StfLevApplyPageState extends State<StfLevApplyPage> {
                        ...
                        /*if(res != null)
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(selectFile!, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
