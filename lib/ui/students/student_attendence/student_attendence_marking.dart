...
class StudentAttendenceMarking extends StatefulWidget {
  @override
  _StudentAttendenceMarkingState createState() =>
      _StudentAttendenceMarkingState();
}

class _StudentAttendenceMarkingState extends State<StudentAttendenceMarking> {
