...
class StdApplyLeaveAdd extends StatefulWidget {
  String  gPickDate, gPStatus;

  StdApplyLeaveAdd(
      {required this.gPickDate, required this.gPStatus});

  @override
  _StdApplyLeaveAddState createState() => _StdApplyLeaveAddState();
}

class _StdApplyLeaveAddState extends State<StdApplyLeaveAdd> {
  ...
  Widget build(BuildContext context) {
    ...
    child:Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Students Apply Leave'),
        leading: IconButton(
          icon: const Icon(
            Icons.arrow_back,
            size: 30,
